...
transformations = [
    ...
    "Восстановление связи с телом", "Интеграция прошлого опыта",
    "Переход от страха к доверию Божественному", "Трансформация ожиданий в принятие реальности"
]
...
blessings = [
    ...
    "Ты имеешь право занимать пространство", "Ты имеешь право быть услышанным", "Ты имеешь право жить в своём ритме",
    "Ты имеешь право не знать", "Ты имеешь право сказать «нет»", "Ты имеешь право менять мнение",
    "Ты имеешь право на ошибку", "Ты имеешь право быть важным", "Ты имеешь право создавать новое",
    "Ты имеешь право быть уязвимым", "Ты имеешь право на свои мечты", "Ты имеешь право опираться на себя",
    "Ты имеешь право на свою правду", "Ты имеешь право быть лидером", "Ты имеешь право действовать",
    "Ты имеешь право быть в процессе", "Ты имеешь право быть недовольным", "Ты имеешь право делать по-своему",
    "Ты имеешь право быть неидеальным", "Ты имеешь право ничего не делать", "Ты имеешь право на внутреннюю свободу",
    "Ты имеешь право быть живым", "Ты имеешь право быть в потоке", "Ты имеешь право быть нежным и сильным",
    "Ты имеешь право быть собой без оправданий"
]
